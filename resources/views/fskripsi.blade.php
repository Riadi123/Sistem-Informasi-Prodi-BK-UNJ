...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <h3 style="text-align: center;">Formulir Pembimbingan Skripsi</h3>
    </div>
    ...
    <pre style="text-align: right; margin-top: 10px;">Deskripsi              :<br>Perbaikan             </pre>
    <pre style="text-align: right; margin-top: 80px;">Deskripsi              :<br>Catatan dari       <br>Pembimbing      </pre>
    </div>
    ...
    <textarea name="message" id="deskripsi1" cols="30" rows="10" placeholder="Masukkan deskripsi perbaikan"></textarea>
    <textarea name="message" id="deskripsi2" cols="30" rows="10" placeholder="Masukkan deskripsi catatan"></textarea>
